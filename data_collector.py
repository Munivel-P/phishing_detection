...
URL_file_name = "tranco_list.csv"#"verified_online_2.csv"
...
df.to_csv("structured_data_phishing_6.csv", mode='a', index=False, header=False)  # header should be false after the first run
